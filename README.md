...
### What I work with
- **Automation:** Playwright, TypeScript, Page Object Model, k6 (load testing)
- **Manual & API:** checklist-based testing, Postman, Swagger
- **Databases:** MS SQL, Oracle, PostgreSQL
- **Quality areas:** functional, negative & edge-case testing,
  accessibility (WCAG 2.1 AA), performance, Lighthouse audits

### Featured projects
- **[LuxeHome-Automation](https://github.com/TemaHromosoma/LuxeHome-Automation)** —
